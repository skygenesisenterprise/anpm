...
# Contributing to ANPM

Thank you for your interest in contributing to **ANPM**!  
...
**ANPM** is the official ANPM of Sky Genesis Enterprise, licensed under **MIT Licence**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/anpm/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
```bash
git clone https://github.com/skygenesisenterprise/anpm.git
cd anpm
```
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/anpm/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to ANPM! 💌
